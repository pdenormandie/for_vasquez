...
#from csv_saver import save_qualifying_loans
...
def get_applicant_info():
    ...
    save_loans = questionary.text("Would you like to save your loans?").ask()
    ...
    if save_loans == "yes" or "Yes":
        def save_qualifying_loans():
    return credit_score, debt, income, loan_amount, home_value, save_loans
